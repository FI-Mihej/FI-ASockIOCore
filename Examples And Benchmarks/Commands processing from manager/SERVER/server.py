...
def run_server():
    ...
    if 'posix' == os.name:
        tcp_settings = ConnectionSettings(ConnectionDirectionRole.server, SERVER_ADDRESS_AF_UNIX, SERVER_KEYWORD,
    ...
    with asock_io_core_connect(tcp_app_server, True) as server:
        ...
        manager_client_tcp_settings = ConnectionSettings(ConnectionDirectionRole.client, keyword=MANAGER_CLIENT_KEYWORD)
        ...
        another_client_tcp_settings = ConnectionSettings(ConnectionDirectionRole.client, keyword=CLIENT_KEYWORD)
